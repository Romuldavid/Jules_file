...
================================================================================
  ...
  Инструменты: Спот юань (CNYRUB_TOM) + Квартальные фьючерсы (CRH3 - CRU6)
...
# ==============================================================================
# 1. ТАБЛИЦА ИЗМЕНЕНИЙ КЛЮЧЕВОЙ СТАВКИ ЦБ РФ (2023 - 2026 гг.)
# ==============================================================================
CBR_RATES_SCHEDULE = [
    ...
    ('2024-10-28', '2026-12-31', 21.00, 'Рекордный уровень ставки 21%')
]
...
# ==============================================================================
# 3. ОСНОВНОЙ МОДУЛЬ РАСЧЕТА БЭКТЕСТА И ТАРИФОВ FORTS (ПО 20.08.2026)
# ==============================================================================
def run_full_cny_cash_and_carry_backtest(initial_capital=1000000.0):
    ...
    FORTS_FEE_PER_CONTRACT = 2.50   # 2.50 руб.
