...
for q_near, q_far, start_d, end_d in quarters:
    ...
    for stock_name, prefix in tickers.items():
        ...
        # Calendar spread: Buy Near + Short Far when spread is contango
        # PnL = (p_near_out - p_near_in) + (p_far_in - p_far_out) = spread_in - spread_out
...
print("\n=== CALENDAR SPREAD ARBITRAGE RESULTS ON STOCK FUTURES (01.01.2023 - 20.08.2026) ===")
...
print(f"Total Profit: {tot_profit:,.2f} RUB ({tot_ret:.2f}%)")
